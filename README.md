...
- Segment selection with server-side validation.
...
4. Submit the form.
5. Review the archetype, tonal summary, primary chain, alternatives, parameter ranges, reasoning, and any warnings.
...
- FFmpeg errors are converted into user-friendly responses.
